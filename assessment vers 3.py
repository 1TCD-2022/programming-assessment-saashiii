...
while True:
   ...
   enter = input("This is a quiz about NZ. Press 't' for truth and 'f' for false. Press 'c' if you wish to continue. Press any other alphabet key to exit: ")
   if enter == "c":
   ...
   if userchoice == "t" or "true":
      ...
      while not userchoice in VALID_CHOICE_ONE:
         userchoice = input ("Incorrect, please enter another answer: ")
   if userchoice == "t" or "true": print("Well done! You have reached the end of the quiz with all answers correct :)")
